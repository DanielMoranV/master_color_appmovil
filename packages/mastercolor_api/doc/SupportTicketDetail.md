...
**parts** | [**List&lt;TicketPart&gt;**](TicketPart.md) | Repuestos consumidos (descuentan inventario). | [optional] 
**visits** | [**List&lt;TicketVisit&gt;**](TicketVisit.md) | Visitas en sitio (check-in/out y reportes de servicio). | [optional] 
**quote** | [**TicketQuote**](TicketQuote.md) | Cotización vigente (la más reciente), si existe. | [optional] 
